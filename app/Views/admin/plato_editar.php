            ...
            <form action="<?= site_url('admin/menu/actualizar/' . $plato['id']) ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-light" 
                          name="descripcion" 
                          rows="3" 
                          style="border-color: #d4af37;"><?= old('descripcion', $plato['descripcion']) ?></textarea>
              </div>
              ...
              <div class="mb-3">
                ...
                <small class="text-muted">Deja vacío si no quieres cambiar la imagen. Máximo 2MB</small>
              </div>
              ...
              <div class="mb-4">
                <div class="form-check form-switch">
                  <input class="form-check-input" 
                         ...
                         name="disponible" 
                         id="disponible" 
                         <?= old('disponible', $plato['disponible']) ? 'checked' : '' ?>
